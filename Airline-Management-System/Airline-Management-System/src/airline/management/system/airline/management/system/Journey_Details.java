...
public class Journey_Details extends JFrame{  //Forth
	...
	JComboBox jComboBox = extracted1(items1);
	...
	JComboBox comboBox_1 = extracted1(items2);
	...
	Show.addActionListener(new ActionListener(){
		...
		try{
                    ...
                    ResultSet rs=((Object) c.s).executeQuery(str);
	...
	private JComboBox extracted1(String[] items2) {
		return extracted1(items2);
	}
}
